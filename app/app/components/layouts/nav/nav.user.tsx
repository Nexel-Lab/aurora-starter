                ...
                <DropdownMenuPortal>
                  <DropdownMenuSubContent>
                    <DropdownMenuItem className='flex cursor-pointer justify-between [&>div:first-child]:flex'>
                      ...
                      <kbd className='font-mono pointer-events-none ml-2 inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 text-[10px] font-medium text-muted-foreground opacity-100'>
                        W
                      </kbd>
                    </DropdownMenuItem>
                    <DropdownMenuItem className='flex cursor-pointer justify-between [&>div:first-child]:flex'>
